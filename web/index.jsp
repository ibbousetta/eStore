<%-- 
    Document   : index
    Created on : 22 avr. 2020, 10:52:24
				...
				<div class="col-sm-12">
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						<ol class="carousel-indicators">
                                                    ...
                                                    %>
							<li data-target="#slider-carousel" data-slide-to="<%=i%>" <%=1==0?"class=\"active\"":""%>></li>
                                                                <%}%>
						</ol>
						...
						<div class="carousel-inner">
							...
							<div class="item <%=(i==0)?" active ":""%>">
								<div class="col-sm-6">
									...
									<h2><%=p.getCategorie().getLibelle()%></h2>
									<p> <%=p.getDescription()%></p>
                                                                        <a href="/eStore/views/detailProduit.jsp?idp=<%=p.getIdp()%>"<button type="button" class="btn btn-default get">Acheter le</button></a>
								</div>
								<div class="col-sm-6">
									<img src="/eStore/images/produit/<%=p.getImages().get(0).getUrl()%>" class="girl img-responsive" alt="" />
									<img src="/eStore/images/produit/pricing.png"  class="pricing" alt="" />
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									...
									<img src="/eStore/images/home/new.png" class="new" alt="" />
								</div>
								<div class="choose">
